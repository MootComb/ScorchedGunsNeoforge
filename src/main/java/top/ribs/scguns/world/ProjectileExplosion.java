...
public abstract class ProjectileExplosion extends Explosion
{
    ...
    public void explode()
    {
        ...
        for(Entity entity : entities)
        {
            ...
            {
                blastDamage = damage * (1.0 - livingEntity.getAttributeValue(Attributes.EXPLOSION_KNOCKBACK_RESISTANCE));
            }
            Vec3 knockback = new Vec3(deltaX * blastDamage, deltaY * blastDamage, deltaZ * blastDamage);
            knockback = EventHooks.getExplosionKnockback(this.world, this, entity, knockback);
    ...
    protected DamageSource getExplosionDamageSource() {
