...
public class AddLootTableModifier extends LootModifier
{
	...
	protected ObjectArrayList<ItemStack> doApply(ObjectArrayList<ItemStack> generatedLoot, LootContext context) {
			ResourceKey<LootTable> lootTableKey = ResourceKey.create(Registries.LOOT_TABLE, this.lootTable);
			LootTable extraTable = context.getResolver().lookupOrThrow(Registries.LOOT_TABLE).getOrThrow(lootTableKey).value();
