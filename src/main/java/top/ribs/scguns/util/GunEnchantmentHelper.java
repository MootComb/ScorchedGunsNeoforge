...
public class GunEnchantmentHelper
{
    ...
    private static void triggerVisualSplashEffect(LivingEntity target, Holder<MobEffect> effect) {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            level.addParticle(ColorParticleOption.create(ParticleTypes.ENTITY_EFFECT, (float) red, (float) green, (float) blue),
                    position.x + offsetX, position.y + offsetY, position.z + offsetZ, 0.0, 0.0, 0.0);
        }
    }
