...
public class ModItems {
    ...
    public static final DeferredItem<Item> TREATED_BRASS_HELMET = REGISTER.register("treated_brass_helmet", () -> new ArmorItem(ModArmorMaterials.TREATED_BRASS, ArmorItem.Type.HELMET, ModArmorMaterials.withDurability(new Item.Properties(), ModArmorMaterials.TREATED_BRASS, ArmorItem.Type.HELMET)));
