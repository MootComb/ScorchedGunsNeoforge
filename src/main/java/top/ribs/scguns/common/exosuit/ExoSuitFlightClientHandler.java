...
public class ExoSuitFlightClientHandler {
    ...
    private static void stopJetpackSounds() {
    ...
    private static void spawnJetpackParticles(Player player, Minecraft mc) {
        ...
        spawnJetParticles(level, leftJetX, baseY, leftJetZ);
        spawnJetParticles(level, rightJetX, baseY, rightJetZ);
    }

    private static void spawnJetParticles(Level level, double x, double y, double z) {
