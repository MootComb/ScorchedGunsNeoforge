...
public class ExoSuitDamageHandler {
    ...
    public static void onLivingAttack(LivingIncomingDamageEvent event) {
        ...
        for (ItemStack exoSuitPiece : exoSuitPieces) {
            float remainingDamage = distributeDamageToComponents(exoSuitPiece, damageToDistribute / exoSuitPieces.size(), player.registryAccess());
    ...
    private static float distributeDamageToComponents(ItemStack exoSuitPiece, float incomingDamage, HolderLookup.Provider provider) {
        ...
        if (needsUpdate) {
            removeBrokenComponents(exoSuitPiece, provider);
        }
    ...
    private static void removeBrokenComponents(ItemStack exoSuitPiece, HolderLookup.Provider provider) {
        ...
        for (int i = 0; i < upgradeList.size(); i++) {
            ...
            ItemStack upgradeStack = ItemStack.parseOptional(provider, upgradeTag);
