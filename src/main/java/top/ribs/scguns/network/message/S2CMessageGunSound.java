...
public class S2CMessageGunSound
{
    public static final StreamCodec<RegistryFriendlyByteBuf, S2CMessageGunSound> STREAM_CODEC = StreamCodec.of(
            S2CMessageGunSound::encode,
            S2CMessageGunSound::decode
    );
    ...
    private static void encode(RegistryFriendlyByteBuf buffer, S2CMessageGunSound message)
    {
    ...
    private static S2CMessageGunSound decode(RegistryFriendlyByteBuf buffer)
    {
