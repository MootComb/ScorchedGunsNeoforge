...
public class S2CMessageProjectileHitEntity
{
    public static final StreamCodec<RegistryFriendlyByteBuf, S2CMessageProjectileHitEntity> STREAM_CODEC = StreamCodec.of(
            S2CMessageProjectileHitEntity::encode,
            S2CMessageProjectileHitEntity::decode
    );
    ...
    private static void encode(RegistryFriendlyByteBuf buffer, S2CMessageProjectileHitEntity message)
    {
    ...
    private static S2CMessageProjectileHitEntity decode(RegistryFriendlyByteBuf buffer)
    {
