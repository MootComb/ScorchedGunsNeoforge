...
{
    public static final StreamCodec<RegistryFriendlyByteBuf, S2CMessageBeamUpdate> STREAM_CODEC = StreamCodec.of(
            S2CMessageBeamUpdate::encode,
            S2CMessageBeamUpdate::decode
    );
    ...
    private static void encode(RegistryFriendlyByteBuf buffer, S2CMessageBeamUpdate message) {
    ...
    private static S2CMessageBeamUpdate decode(RegistryFriendlyByteBuf buffer) {
    ...
    public static void handle(S2CMessageBeamUpdate message, MessageContext context) {
