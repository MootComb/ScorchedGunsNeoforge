...
public class TraumaHookEntity extends FishingHook {
    ...
    public void recreateFromPacket(ClientboundAddEntityPacket packet) {
        // Trauma hooks are mob-owned, so skip FishingHook's player-owner-only recreate check.
        this.syncPacketPositionCodec(packet.getX(), packet.getY(), packet.getZ());
        this.moveTo(packet.getX(), packet.getY(), packet.getZ());
