    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new MeleeAttackGoal(this, 1.2, false) {
            ...
            protected void checkAndPerformAttack(LivingEntity pEnemy) {
                double attackReach = TraumaUnitEntity.this.getBbWidth() * 2.0F * TraumaUnitEntity.this.getBbWidth() * 2.0F + pEnemy.getBbWidth();
                if (TraumaUnitEntity.this.distanceToSqr(pEnemy) <= attackReach && this.getTicksUntilNextAttack() <= 0 && !TraumaUnitEntity.this.isAttacking()) {
