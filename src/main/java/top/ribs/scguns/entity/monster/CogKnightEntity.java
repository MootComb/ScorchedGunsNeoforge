...
public class CogKnightEntity extends Monster {
    ...
    public boolean canBeAffected(@NotNull MobEffectInstance pPotionEffect) {
        ...
        if (effect == MobEffects.POISON ||
                ...
                pPotionEffect.is(ModEffects.SULFUR_POISONING) ||
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new MeleeAttackGoal(this, 1.2, false) {
            ...
            protected void checkAndPerformAttack(LivingEntity pEnemy) {
                double attackReach = CogKnightEntity.this.getBbWidth() * 2.0F * CogKnightEntity.this.getBbWidth() * 2.0F + pEnemy.getBbWidth();
                if (CogKnightEntity.this.distanceToSqr(pEnemy) <= attackReach * 1.5 && this.getTicksUntilNextAttack() <= 0 && !CogKnightEntity.this.isAttacking()) {
