...
public class SulfurheadRenderer extends MobRenderer<SulfurheadEntity, SulfurheadModel<SulfurheadEntity>> {
    ...
    public SulfurheadRenderer(Context context) {
        super(context, new SulfurheadModel<>(context.bakeLayer(ModModelLayers.SULFURHEAD_LAYER)), 0.5F);
        this.addLayer(new SulfurheadGelLayer(this));
        this.addLayer(new SulfurheadPrimeOverlayLayer(this));
    }

    @Override
    public ResourceLocation getTextureLocation(SulfurheadEntity entity) {
        return TEXTURE;
    }

    @Override
    public void render(SulfurheadEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
    ...
    static class SulfurheadPrimeOverlayLayer extends RenderLayer<SulfurheadEntity, SulfurheadModel<SulfurheadEntity>> {
        ...
        public void render(PoseStack poseStack, MultiBufferSource buffer, int packedLight, SulfurheadEntity entity,
            ...
            int color = FastColor.ARGB32.colorFromFloat(0.7F, 1.0F, intensity * 0.8F, 0.2F);
