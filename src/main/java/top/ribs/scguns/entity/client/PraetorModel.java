...
public class PraetorModel<T extends Entity> extends EntityModel<T> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition cube_r1 = head.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(56, 99)
            .addBox(-5.0F, 4.0F, 0.0F, 9.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
            .texOffs(104, 109)
            .addBox(-6.0F, -4.0F, -3.0F, 11.0F, 8.0F, 10.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.5F, -4.85F, -4.85F, 0.3054F, 0.0F, 0.0F)
      );
      PartDefinition mask = head.addOrReplaceChild("mask", CubeListBuilder.create(), PartPose.offset(0.0F, -9.7431F, -4.2957F));
      PartDefinition cube_r2 = mask.addOrReplaceChild(
         "cube_r2",
         CubeListBuilder.create()
            .texOffs(66, 15)
            .addBox(-4.5F, -0.5F, -8.0F, 9.0F, 1.0F, 10.0F, new CubeDeformation(0.0F))
            .texOffs(26, 79)
            .addBox(-5.5F, 0.5F, -2.0F, 11.0F, 8.0F, 1.0F, new CubeDeformation(0.25F))
            .texOffs(0, 0)
            .addBox(-1.0F, -1.5F, -5.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(51, 26)
            .addBox(-4.5F, -1.5F, 0.0F, 9.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
      ...
      PartDefinition torso = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(0, 60)
            .addBox(-8.0F, -10.0F, 2.0F, 16.0F, 8.0F, 11.0F, new CubeDeformation(0.0F))
            .texOffs(62, 43)
            .addBox(-11.0F, -6.0F, 4.0F, 21.0F, 4.0F, 7.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
            .addBox(-9.0F, -2.0F, 1.0F, 18.0F, 10.0F, 15.0F, new CubeDeformation(0.0F))
            .texOffs(92, 81)
            .addBox(-9.0F, -2.0F, -1.0F, 18.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(0, 43)
            .addBox(-9.0F, 8.0F, 1.0F, 18.0F, 4.0F, 13.0F, new CubeDeformation(0.0F))
            .texOffs(0, 25)
            .addBox(-9.0F, 12.0F, -1.0F, 18.0F, 3.0F, 15.0F, new CubeDeformation(0.0F))
            .texOffs(66, 33)
            .addBox(-9.0F, 7.0F, -4.0F, 18.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)),
         PartPose.offset(0.0F, -7.0F, -3.0F)
      );
      PartDefinition cube_r3 = torso.addOrReplaceChild(
         "cube_r3",
         CubeListBuilder.create().texOffs(80, 90).addBox(-10.0F, -6.0F, 0.5F, 18.0F, 6.0F, 3.0F, new CubeDeformation(-0.025F)),
         PartPose.offsetAndRotation(1.0F, 12.2039F, 10.4703F, -0.3927F, 0.0F, 0.0F)
      );
      PartDefinition cube_r4 = torso.addOrReplaceChild(
         "cube_r4",
         CubeListBuilder.create().texOffs(92, 54).addBox(-8.0F, -2.0F, 0.5F, 16.0F, 8.0F, 3.0F, new CubeDeformation(-0.025F)),
         PartPose.offsetAndRotation(0.0F, -6.2039F, 10.4703F, 0.3927F, 0.0F, 0.0F)
      );
      PartDefinition cube_r5 = torso.addOrReplaceChild(
         "cube_r5",
         CubeListBuilder.create().texOffs(36, 90).addBox(-9.5F, -4.5F, -3.0F, 18.0F, 4.0F, 4.0F, new CubeDeformation(-0.025F)),
         PartPose.offsetAndRotation(0.5F, 13.0607F, 1.3033F, 0.7854F, 0.0F, 0.0F)
      );
      PartDefinition cube_r6 = torso.addOrReplaceChild(
         "cube_r6",
         CubeListBuilder.create().texOffs(66, 0).addBox(-8.5F, -3.0F, -1.5F, 18.0F, 9.0F, 6.0F, new CubeDeformation(-0.025F)),
         PartPose.offsetAndRotation(-0.5F, 2.0307F, -0.3181F, -0.3927F, 0.0F, 0.0F)
      );
      PartDefinition cube_r7 = torso.addOrReplaceChild(
         "cube_r7",
         CubeListBuilder.create().texOffs(28, 98).addBox(-4.5F, -3.0F, -0.5F, 11.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-2.8284F, -3.0F, 0.5F, 0.0F, 0.0F, -0.7854F)
      );
      PartDefinition cube_r8 = torso.addOrReplaceChild(
         "cube_r8",
         CubeListBuilder.create().texOffs(106, 15).addBox(-3.5F, -2.0F, -3.0F, 8.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(7.5F, 0.0F, 7.5F, 0.0F, 0.0F, -0.7854F)
      );
      PartDefinition cube_r9 = torso.addOrReplaceChild(
         "cube_r9",
         CubeListBuilder.create().texOffs(86, 99).addBox(-4.5F, -2.0F, -3.0F, 8.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-7.5F, 0.0F, 7.5F, 0.0F, 0.0F, 0.7854F)
      );
      PartDefinition left_leg = partdefinition.addOrReplaceChild(
         "left_leg",
         CubeListBuilder.create().texOffs(54, 60).addBox(-4.0F, -1.0F, -7.0F, 7.0F, 18.0F, 12.0F, new CubeDeformation(0.0F)),
      ...
      PartDefinition right_leg = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(54, 60)
            .mirror()
            .addBox(-3.0F, -1.0F, -7.0F, 7.0F, 18.0F, 12.0F, new CubeDeformation(0.0F))
            .mirror(false),
         PartPose.offset(4.0F, 7.0F, 4.0F)
      );
      ...
      PartDefinition cube_r10 = left_arm.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(92, 65)
            .addBox(-6.5005F, -3.2594F, -5.0F, 7.0F, 7.0F, 9.0F, new CubeDeformation(0.0F))
            .texOffs(88, 109)
            .addBox(-5.5005F, 21.7406F, 0.0F, 8.0F, 12.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(72, 109)
            .addBox(-5.5005F, 19.7406F, -4.0F, 8.0F, 12.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(56, 109)
            .addBox(-5.5005F, 19.7406F, 4.0F, 8.0F, 12.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(0, 79)
            .addBox(-6.5005F, 12.7406F, -5.0F, 8.0F, 9.0F, 10.0F, new CubeDeformation(0.0F))
            .texOffs(0, 98)
            .addBox(-5.5005F, 3.7406F, -4.0F, 6.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(1.75F, -0.5F, 0.0F, 0.0F, 0.0F, 0.0F)
      );
      PartDefinition cube_r11 = left_arm.addOrReplaceChild(
         "cube_r11",
         CubeListBuilder.create().texOffs(51, 29).addBox(17.5894F, 3.7635F, 2.0F, 8.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(1.75F, -0.5F, 0.0F, -3.1416F, 0.0F, 1.8413F)
      );
      PartDefinition right_arm = partdefinition.addOrReplaceChild(
         "right_arm",
         CubeListBuilder.create().texOffs(0, 25).addBox(5.25F, -0.25F, -0.75F, 0.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)),
         PartPose.offset(10.5F, -10.5F, 5.0F)
      );
      PartDefinition cube_r12 = right_arm.addOrReplaceChild(
         "cube_r12",
         CubeListBuilder.create().texOffs(6, 5).addBox(-1.25F, -2.0F, -1.0F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(6.0F, -1.0F, 0.0F, -0.7854F, 0.0F, 0.0F)
      );
      PartDefinition cube_r13 = right_arm.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(92, 65)
            .mirror()
            .addBox(-0.4995F, -3.2594F, -5.0F, 7.0F, 7.0F, 9.0F, new CubeDeformation(0.0F))
            .mirror(false)
            .texOffs(88, 109)
            .mirror()
            .addBox(-2.4995F, 21.7406F, 0.0F, 8.0F, 12.0F, 0.0F, new CubeDeformation(0.0F))
            .mirror(false)
            .texOffs(72, 109)
            .mirror()
            .addBox(-2.4995F, 19.7406F, -4.0F, 8.0F, 12.0F, 0.0F, new CubeDeformation(0.0F))
            .mirror(false)
            .texOffs(56, 109)
            .mirror()
            .addBox(-2.4995F, 19.7406F, 4.0F, 8.0F, 12.0F, 0.0F, new CubeDeformation(0.0F))
            ...
            .texOffs(0, 79)
            .mirror()
            .addBox(-1.4995F, 12.7406F, -5.0F, 8.0F, 9.0F, 10.0F, new CubeDeformation(0.0F))
            .mirror(false)
            .texOffs(0, 98)
            .mirror()
            .addBox(-0.4995F, 3.7406F, -4.0F, 6.0F, 9.0F, 8.0F, new CubeDeformation(0.0F))
            .mirror(false),
         PartPose.offsetAndRotation(-1.75F, -0.5F, 0.0F, 0.0F, 0.0F, 0.0F)
      );
      PartDefinition cube_r14 = right_arm.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(51, 29)
            .mirror()
            .addBox(-25.5894F, 3.7635F, 2.0F, 8.0F, 9.0F, 0.0F, new CubeDeformation(0.0F))
            .mirror(false),
         PartPose.offsetAndRotation(-1.75F, -0.5F, 0.0F, -3.1416F, 0.0F, -1.8413F)
      );
   ...
   public void setupAnim(@NotNull T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      if (limbSwingAmount > 0.01F) {
         ...
         if (entity instanceof PraetorEntity praetorx && praetorx.isRoaring()) {
            return;
         }
