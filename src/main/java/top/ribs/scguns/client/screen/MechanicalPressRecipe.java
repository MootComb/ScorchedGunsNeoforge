...
public class MechanicalPressRecipe implements Recipe<MechanicalPressRecipe.Input> {
    private final NonNullList<Ingredient> inputItems;
    private final Ingredient moldItem;
    private final ItemStack output;
    private final int processingTime;

    public MechanicalPressRecipe(NonNullList<Ingredient> inputItems, Ingredient moldItem, ItemStack output, int processingTime) {
    ...
    public static class Serializer implements RecipeSerializer<MechanicalPressRecipe> {
        ...
        ).apply(instance, (ingredients, moldItem, output, processingTime) ->
                new MechanicalPressRecipe(toNonNullList(ingredients), moldItem, output, processingTime)));
        ...
        private static MechanicalPressRecipe decode(RegistryFriendlyByteBuf buffer) {
            ...
            return new MechanicalPressRecipe(ingredients, moldItem, output, processingTime);
        }

        private static void encode(RegistryFriendlyByteBuf buffer, MechanicalPressRecipe recipe) {
