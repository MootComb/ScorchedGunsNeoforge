...
public class MaceratorRecipe implements Recipe<MaceratorRecipe.Input> {
    private final NonNullList<Ingredient> inputItems;
    private final ItemStack output;
    private final int processingTime;

    public MaceratorRecipe(NonNullList<Ingredient> inputItems, ItemStack output, int processingTime) {
    ...
    public static class Serializer implements RecipeSerializer<MaceratorRecipe> {
        ...
        private static final MapCodec<MaceratorRecipe> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
                ...
                new MaceratorRecipe(toNonNullList(ingredients), output, processingTime)));
        ...
        private static MaceratorRecipe decode(RegistryFriendlyByteBuf buffer) {
            ...
            return new MaceratorRecipe(ingredients, output, processingTime);
        }

        private static void encode(RegistryFriendlyByteBuf buffer, MaceratorRecipe recipe) {
