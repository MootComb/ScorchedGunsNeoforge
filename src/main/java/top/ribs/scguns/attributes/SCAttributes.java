...
public class SCAttributes {
    public static final DeferredRegister<Attribute> ATTRIBUTES = DeferredRegister.create(Registries.ATTRIBUTE, ScorchedGuns.MODID);
    ...
    //public static final DeferredHolder<Attribute, Attribute> FIRE_RATE_MULTIPLIER = ATTRIBUTES.register("fire_rate_multiplier",
