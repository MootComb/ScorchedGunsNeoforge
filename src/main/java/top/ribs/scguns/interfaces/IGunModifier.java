...
public interface IGunModifier
{
    ...
    /**
     * Modify the reload speed of the weapon. This can decrease or increase the reload speed
     * based on the attachment. A value less than 1 decreases reload speed (makes it faster),
     * while a value greater than 1 increases it (makes it slower).
     *
     * @param reloadSpeed the current reload speed
     * @return the modified reload speed
     */
    ...
    /**
     * Modify the ammo capacity of the weapon based on the attachment.
     * @param baseCapacity the base capacity of the weapon
     * @return the modified ammo capacity
     */
